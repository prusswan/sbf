...
describe "2019 May Brochure" do
  sbf_link = 'https://esales.hdb.gov.sg/bp25/launch/19may/bto/19MAYSBF_page_4196/about0.html'
  ...
  def check_search_window(estate_name)
    ...
    within_window(->{ page.title.include? 'Flats Available' }) do
      # p page.body
